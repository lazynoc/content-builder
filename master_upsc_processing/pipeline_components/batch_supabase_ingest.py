#!/usr/bin/env python3
"""
Batch Supabase Ingestion Script for All Chapter Files
====================================================

This script processes all chapter JSON files and moves them to 'stored_in_vdb' folder.
"""
...
# Directory paths
SOURCE_DIR = "Books/Environment_Book_Chapters/proper_chapters/stored_in_vdb"
STORED_DIR = "Books/Environment_Book_Chapters/proper_chapters/stored_in_vdb"
...
def main():
    ...
    # Save results
    results_file = os.path.join(STORED_DIR, "batch_results.json")
    with open(results_file, 'w') as f:
        json.dump({
            'date': datetime.now().isoformat(),
            'summary': {'total': len(results), 'successful': successful, 'skipped': skipped, 'errors': errors, 'chunks': total_chunks},
            'results': results
        }, f, indent=2)
