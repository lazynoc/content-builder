#!/usr/bin/env python3
"""
Test NCERT OCR Processing
=========================

This script tests the OCR extractor with one chapter from each NCERT subject.
"""
...
def test_ncert_ocr():
    """Test OCR processing with one chapter from each NCERT subject."""
    
    print("🧪 Testing NCERT OCR Processing")
    print("=" * 50)
    ...
    # Test chapters from each subject
    test_chapters = [
        {
            "subject": "Geography",
            "path": "Books/NCERT_Books/geography/9/contemporary_India_I/chapter_01.pdf",
            "file_id": "geography_class_9_book_contemporary_India_I_chapter_1"
        },
        {
            "subject": "History", 
            "path": "Books/NCERT_Books/history/9/india_and_contemporary_world_2/chapter_01.pdf",
            "file_id": "history_class_9_book_india_and_contemporary_world_2_chapter_1"
        },
        {
            "subject": "Political Science",
            "path": "Books/NCERT_Books/political/11/indian_constitution_at_work/chapter_01.pdf", 
    ...
    for test_case in test_chapters:
        ...
        try:
            ...
            output_file = output_dir / f"{subject.lower()}_test_result.json"
