...
def extract_2018_missing_questions():
    """Extract missing questions for 2018."""
    ...
    missing_questions = [
        {'questions': [15], 'pages': [15, 16]},
        {'questions': [23], 'pages': [23]},
        {'questions': [25], 'pages': [24]},
        {'questions': [39, 40, 41], 'pages': [37, 38]},
        {'questions': [68], 'pages': [61]},
        {'questions': [70], 'pages': [63, 64]},
        {'questions': [73], 'pages': [66, 67]},
        {'questions': [77, 78, 79], 'pages': [70, 71, 72]},
        {'questions': [92, 93, 94], 'pages': [81, 82, 83, 84]}
    ]
...
def update_2018_json(new_questions: List[PYQQuestionHybrid]):
    """Update 2018 JSON file with new questions."""
...
def main():
    """Extract missing questions for 2018 only."""
    
    print("Starting targeted extraction for 2018...")
    
    # Extract missing questions
    missing_questions = extract_2018_missing_questions()
    
    if missing_questions:
        # Update existing JSON file
        update_2018_json(missing_questions)
    else:
        print("[2018] No missing questions were extracted")
    
    print("2018 extraction process finished!")
