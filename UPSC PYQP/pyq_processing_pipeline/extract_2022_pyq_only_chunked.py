...
def main():
    ...
    print("🔍 EXTRACTING GS PRELIMS 2022 - PYQ ONLY")
    print("=" * 60)
    
    # Extract questions
    questions = extract_pyq_only_chunked(pdf_path)
    ...
    # Save to file
    output_path = OUTPUT_DIR / f"GS Prelims 2022_PYQ_ONLY_chunked.json"
