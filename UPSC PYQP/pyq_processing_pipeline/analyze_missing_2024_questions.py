#!/usr/bin/env python3
"""
Script to run OpenAI analysis for the 4 missing 2024 questions (22, 25, 66, 84)
...
def analyze_missing_questions():
    ...
    # Load the original 2024 file
    input_file = "GS Prelims 2024_WITH_OPENAI_ANALYSIS.json"
    ...
    # Questions to analyze (22, 25, 66, 84)
    target_questions = ["22", "25", "66", "84"]
