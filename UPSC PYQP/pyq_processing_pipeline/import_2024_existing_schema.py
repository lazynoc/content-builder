...
class ExistingSchemaImport:
        ...
        try:
            ...
            for question in questions:
                try:
                    ...
                    cursor.execute("SELECT id FROM questions WHERE year = %s AND question_number = %s", 
    ...
    def verify_import(self):
        ...
        try:
            ...
            cursor.execute("""
                SELECT difficulty_level, COUNT(*) FROM questions 
                WHERE year = 2024 
            ...
            cursor.execute("""
                SELECT primary_type, COUNT(*) FROM questions 
                WHERE year = 2024 
            ...
            cursor.execute("""
                ...
                FROM questions WHERE year = 2024 LIMIT 1
            """)
...
def main():
    """Main function to import data into existing schema"""
    ...
    importer = None
    try:
        print("🚀 Starting 2024 UPSC Questions Import (Existing Schema)...")
        print("=" * 60)
        
        # Initialize importer
        importer = ExistingSchemaImport()
