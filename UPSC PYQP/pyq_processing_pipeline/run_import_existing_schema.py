#!/usr/bin/env python3
"""
Import 2024 UPSC questions into existing Supabase schema
"""

import os
import sys
from import_2024_existing_schema import ExistingSchemaImport

def main():
    """Run the import process with existing schema"""
